...
public class chromeDriver {
	...
	public static void main(String[] args) throws IOException {
		...
		chromeDriver.findElement(By.linkText("ÍÎÂÎÑÒÈ")).click();
		checkTitle(chromeDriver, "Íîâîñòè - 4PDA");
		takeScreenshot(chromeDriver, "news.png");
		
		chromeDriver.navigate().back();
		
		chromeDriver.findElement(By.linkText("ÎÁÇÎÐÛ")).click();
		checkTitle(chromeDriver, "Îáçîðû - 4PDA");
		takeScreenshot(chromeDriver, "reviews.png");
		
		chromeDriver.navigate().back();
		
		chromeDriver.findElement(By.linkText("ÏÐÎÃÐÀÌÌÛ")).click();
		checkTitle(chromeDriver, "Ïðîãðàììû - 4PDA");
